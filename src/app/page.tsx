...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col font-sans bg-[#f0fdfa] text-slate-900 overflow-x-hidden selection:bg-[#ffc174]/30">
      
      {/* Top Navigation Bar */}
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-4 sm:px-6 md:px-10 h-20 bg-white/60 backdrop-blur-xl border-b border-teal-100 shadow-md transition-all duration-300" id="mainNav">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/plan" className="text-slate-600 font-semibold text-sm hover:text-[#0f766e] transition-colors duration-300">Plan Trip</Link>
          <Link href="/day-plan" className="text-slate-600 font-semibold text-sm hover:text-[#0f766e] transition-colors duration-300">Plan Day</Link>
          <Link href="/dashboard" className="text-slate-600 font-semibold text-sm hover:text-[#0f766e] transition-colors duration-300">Itineraries</Link>
        </div>
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          {user ? (
            ...
            <>
              <Link href="/login" className="text-slate-600 font-semibold text-sm hover:text-[#ffc174] transition-colors">Log in</Link>
              <Link href="/signup">
                <button className="bg-gradient-to-br from-[#f59e0b] to-[#d97706] shadow-[0_10px_25px_-5px_rgba(245,158,11,0.4)] px-4 py-2 sm:px-6 sm:py-2.5 rounded-xl text-slate-900 font-semibold text-sm scale-105 transition-transform hover:opacity-90">
                  Sign up
                </button>
              </Link>
            </>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 px-4 md:px-0">
        ...
        <div className="relative z-20 text-center max-w-4xl mx-auto px-4">
          {/* Floating Icon */}
          <div className="inline-flex items-center justify-center p-3 rounded-2xl bg-white/5 border border-teal-100 backdrop-blur-md mb-8 animate-bounce shadow-[0_10px_25px_-5px_rgba(245,158,11,0.2)]">
             <img src="/logo-v2.png" className="w-14 h-14 rounded-xl object-contain drop-shadow-lg" alt="NaviBharat Logo" />
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-[80px] font-extrabold text-slate-900 mb-6 leading-tight tracking-tight break-words">
            NaviBharat
          </h1>
          <p className="text-lg md:text-xl text-slate-600 mb-12 max-w-2xl mx-auto opacity-90 leading-relaxed font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="/day-plan">
               <button className="bg-white/80 backdrop-blur-md border border-teal-100 shadow-xl px-8 py-4 rounded-2xl text-slate-900 font-bold text-lg transition-all hover:scale-105 active:scale-95 group flex items-center hover:bg-white hover:text-[#0f766e]">
                 Plan your day
      ...
      <section className="py-24 px-4 md:px-10 bg-[#f0fdfa] relative overflow-hidden">
        <div className="max-w-[1280px] mx-auto relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">How NaviBharat Works</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-[#f59e0b] to-[#d97706] mx-auto rounded-full"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="backdrop-blur-xl bg-white/60 border border-teal-100 p-8 rounded-3xl group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Set Requirements</h3>
              <p className="text-slate-600 font-medium opacity-80 leading-relaxed">
            ...
            <div className="backdrop-blur-xl bg-white/60 border border-teal-100 p-8 rounded-3xl group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">AI Generation</h3>
              <p className="text-slate-600 font-medium opacity-80 leading-relaxed">
            ...
            <div className="backdrop-blur-xl bg-white/60 border border-teal-100 p-8 rounded-3xl group hover:scale-[1.02] transition-all duration-500">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4">Review &amp; Travel</h3>
              <p className="text-slate-600 font-medium opacity-80 leading-relaxed">
      ...
      {/* Feedback Section */}
      <section className="py-24 px-4 md:px-10 bg-[#e2e8f0] border-t border-teal-50">
        <div className="max-w-2xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-12">We value your feedback</h2>
          <div className="backdrop-blur-xl bg-white/60 border border-teal-100 p-8 md:p-12 rounded-[2rem] text-left shadow-2xl">
            <form onSubmit={handleFeedbackSubmit} className="space-y-6">
              <div className="space-y-2">
                <label className="font-semibold text-sm text-slate-600 ml-1">Name</label>
                <input 
                  type="text" 
                  value={feedbackName} 
                  onChange={(e) => setFeedbackName(e.target.value)} 
                  required 
                  className="w-full bg-[#f0fdfa] border border-teal-100 rounded-xl px-4 py-3 text-slate-900 focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent transition-all outline-none" 
                  placeholder="Your name" 
                />
              </div>
              <div className="space-y-2">
                <label className="font-semibold text-sm text-slate-600 ml-1">Message</label>
                <textarea 
                  value={feedbackMsg} 
                  onChange={(e) => setFeedbackMsg(e.target.value)} 
                  required 
                  className="w-full bg-[#f0fdfa] border border-teal-100 rounded-xl px-4 py-3 text-slate-900 focus:ring-2 focus:ring-[#f59e0b] focus:border-transparent transition-all outline-none resize-none" 
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-[#f59e0b] to-[#d97706] px-8 py-4 rounded-xl text-slate-900 font-bold text-lg hover:shadow-[0_10px_25px_-5px_rgba(245,158,11,0.4)] transition-all hover:scale-[1.01] active:scale-95 disabled:opacity-50 disabled:scale-100 disabled:cursor-not-allowed"
              >
      ...
      {/* Footer */}
      <footer className="w-full py-12 px-6 md:px-10 bg-[#e2e8f0] border-t border-teal-100">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between items-start gap-6">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm font-medium text-slate-600 opacity-60 max-w-xs leading-relaxed">
          ...
          <div className="flex justify-start md:justify-end w-full">
            <details className="group cursor-pointer relative">
              ...
              <div className="absolute bottom-full mb-2 right-0 p-5 bg-white/90 backdrop-blur-xl border border-[#ffc174]/20 rounded-xl shadow-2xl text-left min-w-[240px] opacity-0 translate-y-2 group-open:opacity-100 group-open:translate-y-0 transition-all duration-300">
                <p className="text-slate-600 text-sm font-medium">Designed & Developed by</p>
                <p className="text-[#f59e0b] text-xl font-bold mt-1 tracking-wide">AYUSH</p>
                <div className="h-px w-full bg-white/10 my-3"></div>
                <ul className="space-y-2 text-xs text-slate-600/80">
        ...
        <div className="mt-16 pt-8 border-t border-teal-50 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm font-medium text-slate-600 opacity-60">© {new Date().getFullYear()} NaviBharat AI. Explorers Welcome.</p>
        </div>
      </footer>
