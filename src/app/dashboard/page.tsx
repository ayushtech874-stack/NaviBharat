...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-[#020617] text-[#dce1fb] min-h-screen font-sans selection:bg-[#ffc174]/30 overflow-x-hidden">
      <ActionModal
      ...
      {/* Navigation */}
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 md:px-10 py-4 bg-[#0f172a]/60 backdrop-blur-xl border-b border-white/10 shadow-lg shadow-[#ffc174]/10">
      ...
      <main className="relative z-10 pt-28 pb-20 px-6 md:px-10 max-w-[1280px] mx-auto">
        ...
        <header className="mb-16 md:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="max-w-2xl">
            <span className="inline-block py-1 px-3 mb-4 rounded-full bg-[#4fdbc8]/10 text-[#4fdbc8] text-sm font-semibold border border-[#4fdbc8]/20">
        ...
        <section>
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <h2 className="text-3xl font-semibold text-[#dce1fb] flex items-center gap-3">
              ...
              Your Itineraries
              <span className="text-sm font-normal text-[#d8c3ad] bg-white/5 px-3 py-1 rounded-full ml-2 border border-white/10">{trips.length} Saved</span>
            </h2>
            <div className="relative w-full md:w-72">
              <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#d8c3ad]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
              <input type="text" placeholder="Search trips..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full bg-[#0f172a]/60 backdrop-blur-md border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-sm text-[#dce1fb] placeholder:text-[#d8c3ad]/50 focus:outline-none focus:border-[#ffc174]/50 transition-colors shadow-inner" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {loading ? (
              <div className="col-span-full py-20 text-center flex flex-col items-center justify-center">
                ...
                <p className="text-xl text-[#d8c3ad] font-medium">Fetching your planned journeys...</p>
              </div>
            ) : trips.length === 0 ? (
               <div className="col-span-full py-16 text-center text-[#d8c3ad] font-medium text-xl bg-[#0f172a]/40 rounded-3xl border border-dashed border-white/20 backdrop-blur-md">
                  ...
                  <div className="p-6 relative z-20">
                    <div className="flex items-center justify-between mb-6">
                      <div className="text-center w-1/3">
                        <p className="text-[#d8c3ad] text-xs font-semibold uppercase tracking-wider mb-1 truncate">{trip.source}</p>
                        <p className="text-2xl font-bold text-[#ffc174] truncate">{trip.source.substring(0,3).toUpperCase()}</p>
                      </div>
                      <div className="flex-1 px-2 flex flex-col items-center">
                        <svg className="text-[#d8c3ad] w-5 h-5 mb-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.2-1.1.7l-1.2 3.3c-.2.6.2 1.2.8 1.3l5.7 1.5 2.5 7.5c.2.5.6.8 1.2.7l3.3-1.2c.5-.2.8-.6.7-1.1z"/><path d="M3 21h18"/></svg>
                        <div className="w-full border-t border-dashed border-white/20 relative">
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#020617] px-2 rounded-full text-[#ffc174]">
                      ...
                      <div className="text-center w-1/3">
                        <p className="text-[#d8c3ad] text-xs font-semibold uppercase tracking-wider mb-1 truncate">{trip.destination}</p>
                        <p className="text-2xl font-bold text-[#ffc174] truncate">{trip.destination.substring(0,3).toUpperCase()}</p>
                      </div>
                    </div>

                    <div className="space-y-3 mb-8">
                      <div className="flex items-center gap-3 text-[#d8c3ad]">
                        <svg className="text-[#4fdbc8] w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
                        <span className="text-base">{trip.days} Days / {trip.nights} Nights</span>
                      </div>
                      <div className="flex items-center gap-3 text-[#d8c3ad]">
                        <svg className="text-[#4fdbc8] w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                        <span className="text-base">{trip.travelers} Travelers</span>
                      </div>
                      <div className="flex items-center gap-3 text-[#dce1fb] font-semibold bg-white/5 p-2 rounded-lg border border-white/5">
                        <svg className="text-[#4fdbc8] w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="14" x="2" y="5" rx="2"/><line x1="2" x2="22" y1="10" y2="10"/></svg>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-white/5">
                      <Link href={`/itinerary/${trip.id}`}>
                        <button className="flex items-center gap-2 text-[#d8c3ad] hover:text-[#ffc174] transition-colors cursor-pointer">
                      ...
                      <button onClick={() => handleDownload(trip.id)} className="flex items-center gap-2 text-[#d8c3ad] hover:text-[#4fdbc8] transition-colors cursor-pointer">
            ...
            <Link href="/plan" className="block focus:outline-none">
              <div className="h-full min-h-[420px] backdrop-blur-xl bg-[#0f172a]/40 border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center p-12 text-center group cursor-pointer hover:border-[#ffc174]/50 hover:bg-[#0f172a]/80 transition-all duration-500 shadow-lg">
                ...
                <h3 className="text-2xl font-semibold text-[#dce1fb] mb-2 tracking-wide">Forge a New Journey</h3>
                <p className="text-base text-[#d8c3ad] max-w-[200px] mb-8 group-hover:text-[#ffc174] transition-colors">
                    The world is wide. Let our AI map your path.
                </p>
                <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#ffc174] group-hover:bg-[#ffc174] group-hover:text-[#2a1700] group-hover:shadow-[0_0_20px_rgba(245,158,11,0.5)] transition-all duration-300">
